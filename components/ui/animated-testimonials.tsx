...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="mx-auto max-w-xsm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          <motion.div
            ...
            <h3 className="text-2xl font-bold text-black/72 ">{testimonials[active].name}</h3>
